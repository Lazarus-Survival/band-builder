(function installApprovedCardIcons(){
  const POS={
    ...
    "Activista Z":[0,3],"Adicción":[1,3],"Alucinaciones":[2,3],"Bajo de Forma":[3,3],"Cojo":[4,3],"Corto de vista":[5,3],"Depresivo":[6,3],"Egoísta":[7,3],"Gafe":[8,3],"Honorable":[9,3],
    "Imprudente":[0,4],"Lobo Solitario":[1,4],"Mal Olor":[2,4],"Manco":[3,4],"Miedoso":[4,4],"Paranoico":[5,4],"Rencoroso":[6,4],"Suicida":[7,4],"Turbio":[8,4],"Viejo":[9,4]
  };
  let tries=0;
  const timer=setInterval(()=>{
    tries++;
    if(typeof iconBadge!=="function" || typeof pictogram!=="function" || typeof renderSummary!=="function" || !window.APPROVED_ICON_SPRITE){
      if(tries>=200){clearInterval(timer);console.error("No se pudo inicializar la ficha visual antes de instalar los iconos aprobados.");}
      return;
    }
    clearInterval(timer);
